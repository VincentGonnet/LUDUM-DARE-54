...
public class EnemyController : MonoBehaviour {
    ...
    public void takeHit(){
        health -= player.GetComponent<PlayerProperties>().strength;
        Debug.Log("Enemy " + this.name + " took " + player.GetComponent<PlayerProperties>().strength + " damage. Health left : " + health);
